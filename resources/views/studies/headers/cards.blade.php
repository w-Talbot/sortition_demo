...
{{--    item-to-check : These could be linked to real data / or need to be completely deleted--}}
<div class="col-xl-3 col-md-6">
    <div class="card card-stats">
        <!-- Card body -->
        <div class="card-body">
...
<div class="col-xl-3 col-md-6">
    <div class="card card-stats">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <h5 class="card-title text-uppercase text-muted mb-0">Lost to Follow-up</h5>
