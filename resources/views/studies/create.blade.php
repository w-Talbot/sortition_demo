...
{{--                                     item-to-check--}}
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="form-group{{ $errors->has('site_name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="site_name" id="site_name" class="form-control{{ $errors->has('site_name') ? ' is-invalid' : '' }}" placeholder="{{ __('Site name') }}" value="{{ old('site_name') }}" required autofocus>
