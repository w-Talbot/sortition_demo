    ...
    <div class="scrollbar-inner scroll-scrollx_visible">
        <div class="sidenav-header d-flex align-items-center">
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ asset('sortition') }}/img/sortition_logo.png" class="navbar-brand-img" alt="...">
            </a>
            <div class="ml-auto">
                <!-- Sidenav toggler -->
        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item {{ $parentSection == 'manage' ? 'active' : '' }}">
                        <a class="nav-link" href="#navbar-manage" data-toggle="collapse" role="button" aria-expanded="{{ $parentSection == 'manage' ? 'true' : '' }}" aria-controls="navbar-manage">
                            <i class="ni ni-ui-04 text-info"></i>
                            <span class="nav-link-text">{{ __('Manage') }}</span>
                        </a>
                        <div class="collapse {{ $parentSection == 'manage' ? 'show' : '' }}" id="navbar-manage">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item {{ $elementName == 'profile' ? 'active' : '' }}">
                                    <a href="{{ route('profile.edit') }}" class="nav-link">{{ __('My Profile') }}</a>
                                </li>
                    ...
                    <li class="nav-item {{ $parentSection == 'help-docs' ? 'active' : '' }}">
                        <a class="nav-link" href="#navbar-help-docs" data-toggle="collapse" role="button" aria-expanded="{{ $parentSection == 'help-docs' ? 'true' : '' }}" aria-controls="navbar-help-docs">
                            <i class="ni ni-single-copy-04 text-pink"></i>
                            <span class="nav-link-text">{{ __('Help') }}</span>
                        </a>
                        <div class="collapse {{ $parentSection == 'help-docs' ? 'show' : '' }}" id="navbar-help-docs">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item {{ $elementName == 'general' ? 'active' : '' }}">
                                    <a href="#" class="nav-link">{{ __('General') }}</a>
                                </li>
                            </ul>
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item {{ $elementName == 'Admin' ? 'active' : '' }}">
                                    <a href="#" class="nav-link">{{ __('Admin') }}</a>
                                </li>
                            </ul>
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item {{ $elementName == 'stats' ? 'active' : '' }}">
                                    <a href="#" class="nav-link">{{ __('Stats') }}</a>
                                </li>
                            </ul>
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item {{ $elementName == 'blind' ? 'active' : '' }}">
                                    <a href="#" class="nav-link">{{ __('Blind') }}</a>
                                </li>
                            </ul>
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item {{ $elementName == 'it' ? 'active' : '' }}">
                                    <a href="#" class="nav-link">{{ __('IT') }}</a>
                                </li>
                            </ul>
                        </div>
                    </li>
{{--                    item-to-check : remove all this extra template sutff:--}}
